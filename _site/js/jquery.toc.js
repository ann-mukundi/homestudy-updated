...
(function($) {
    var toggleHTML = '';
    var tocContainerHTML = '<a href="/"><h1>The Andela Curriculum</h1></a>%2';

    function createLevelHTML(anchorId, tocLevel, tocSection, tocNumber, tocText, tocInner, possibleLink) {
        var link;
        if(possibleLink && possibleLink.is('a') && possibleLink.attr('href')){
            link = possibleLink[0].outerHTML;
        }
        else {
            link = '<a href="#%1">%3</a>%4'
                .replace('%1', anchorId)
